...
import LastMonthRevenuNSSkeleton from "./last-month-revenu-skeleton";
        ...
        >
          <div className="flex flex-col">
            <CardHeader className="flex justify-between items-center">
              <CardTitle>Чеки ночных магазинов (за текущий месяц)</CardTitle>
            </CardHeader>
...
export default LastMonthRevenuNS;
