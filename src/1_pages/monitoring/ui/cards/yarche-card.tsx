...
import { YarcheProduct } from "../../config/types";
import { YarcheModal } from "./yarche-modal";

interface YarcheCardProps {
...
export const YarcheCard = ({
  data,
  product,
  variant = "grid",
  onRemove,
}: YarcheCardProps) => {
  const { image, weight, name, brand, price, previous_price, categories, id } =
    data;
