export const mails = [
  {
    ...
    name: "📈 Итог работы вашего магазина",
    email: "williamsmith@example.com",
    subject:
      "📊 Обзор показателей: выручка, чеки, списание. Оцените прогресс выполнения планов и выявите проблемные точки.",
    text: `
