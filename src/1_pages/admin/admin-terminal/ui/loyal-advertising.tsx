  ...
  return (
    <div className="flex flex-row gap-8">
        ...
        {/* <Card style={{
                        ...
                        >
                            <div 
                                ...
                                className={`w-[334px] h-[224px] ml-[23px] absolute -bottom-42 rounded-3xl ${
                                    previewUrl ? 'bg-cover bg-center bg-no-repeat' : 'bg-amber-300'
                                }`}
                            ></div>
                        </Card> */}
        <div className="w-96 h-164 bg-white rounded-xl">
          <div className="w-full flex rounded-3xl justify-center">
            <div
              style={{
                backgroundImage: previewUrl ? `url(${previewUrl})` : undefined,
              }}
              className="w-[334px] h-[224px] mt-[36px] bg-amber-300 rounded-3xl bg-cover bg-center bg-no-repeat"
            ></div>
          </div>
      ...
      <div className="flex flex-col gap-4 min-w-80">
        <div>
          <p className="text-lg font-medium mb-2">Изменить экран лояльности</p>
