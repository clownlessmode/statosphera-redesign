...
export const TV = () => {
  ...
  return (
    <div className="bg-muted min-h-screen w-full p-2 flex flex-col gap-2">
      <div
        className="rounded-3xl h-full  bg-background p-4 gap-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4"
        style={{ gridTemplateRows: "repeat(auto-fit, 400px)" }}
      >
