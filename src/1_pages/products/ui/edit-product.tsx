                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <MultiSelect
                            ...
                            onOpenChange={(open) =>
                              handleOpenFranchiseSelect(open)
                            }
                            onValueChange={(value) => {
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <MultiSelect
                            ...
                            onOpenChange={(open) =>
                              handleOpenDirectionsSelect(open)
                            }
                            onValueChange={(value) => {
                              const numericValues = value.map(String);
                              field.onChange(numericValues);
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <MultiSelect
                            ...
                            onOpenChange={(open) =>
                              handleOpenEconomistsSelect(open)
                            }
                            onValueChange={(value) => {
                              const numericValues = value.map(String);
                              field.onChange(numericValues);
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <MultiSelect
                            ...
                            onOpenChange={(open) =>
                              handleOpenAutoManagerSelect(open)
                            }
                            onValueChange={(value) => {
                              const numericValues = value.map(String);
                              field.onChange(numericValues);
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <MultiSelect
                          ...
                          onOpenChange={(open) =>
                            handleOpenTypeSenderSelect(open)
                          }
                          onValueChange={(value) => {
                            const numericValues = value.map(String);
                            field.onChange(numericValues);
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <MultiSelect
                          ...
                          onOpenChange={(open) =>
                            handleOpenSubgroupsSelect(open)
                          }
                          onValueChange={(value) => {
                            const numericValues = value.map(String);
                            field.onChange(numericValues);
