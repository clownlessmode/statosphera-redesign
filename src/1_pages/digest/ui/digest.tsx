...
const Digest = () => {
  ...
  return (
    <div className="bg-muted h-full min-h-screen w-full p-2 flex flex-col gap-2">
      <Header title={!isMobile ? `Дайджест ${digest?.name_daydjest}` : ""} />
      <div className="relative rounded-3xl bg-background px-4 pt-4 gap-4 h-fit flex flex-col min-h-screen">
        <div className="mx-2 p-2 md:p-5 backdrop-blur-2xl rounded-xl w-fit  border-border/5 border sticky top-4 bg-background/40">
        ...
        <AnimatePresence>
          <div className="left-0 sticky z-10 bottom-4 w-full justify-center flex items-center px-2">
            <div className="flex flex-row gap-4 justify-center md:justify-between w-full">
              <div className="flex gap-2 p-2 md:p-5 backdrop-blur-2xl rounded-xl border-border/5 border bg-background/40">
