...
const Lessons = () => {
  ...
  return (
    <div className="bg-muted min-h-screen w-full p-2 flex flex-col gap-2">
      ...
      <div className="rounded-3xl min-h-[calc(100vh-124px)] bg-background p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 auto-rows-[320px]">
        {isLoading
