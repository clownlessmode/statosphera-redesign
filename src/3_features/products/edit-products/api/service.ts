...
import { Product, UpdateProductPayload } from "../config";
import { AutoManagerFilterResponse, DirectionFilterResponse, FranchiseFilterResponse, GroupEconomistFilterResponse, GroupMainFilterResponse, NomenklaturaFilterResponse, SeasonFilterResponse, SubdivisionFilterResponse, SubgroupFilterResponse, SubSubGroupFilterResponse, TeamFilterResponse, TypeSenderFilterResponse } from "@entities/report/model/api/filters/products/types";

export class GetProductsService {
    static async updateProduct(payload: UpdateProductPayload): Promise<Product> {
        const response = await api.patch<Product>(`products/update-nomenclature`, payload);
