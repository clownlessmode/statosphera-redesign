...
export const EditProduct: FC<Props> = ({
  ...
  return (
    <Dialog open={true} onOpenChange={(open) => !open && onClose?.()}>
      ...
      <DialogContent
        className="p-0 rounded-xl border-none max-md:px-2 max-md:w-full max-md:overflow-y-auto scrollbar-hide max-md:h-[calc(100vh-96px)] md:min-w-[800px] lg:min-w-[1000px] "
