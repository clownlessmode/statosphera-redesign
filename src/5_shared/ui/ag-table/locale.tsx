export const AG_GRID_LOCALE_RU = {
  ...
  chart: "Chart",
  title: "Title",
  titlePlaceholder: "Chart title - double click to create",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. Level ${variable}. Press ENTER to create.",
  ariaAdvancedFilterBuilderItemValidation:
    "${variable}. Level ${variable}. ${variable} Press ENTER to create.",
